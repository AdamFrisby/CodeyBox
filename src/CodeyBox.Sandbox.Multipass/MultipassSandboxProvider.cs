...
""";
        ...
        sb.AppendLine("import os, socket, sys, urllib.parse");
        ...
        sb.AppendLine("parsed = urllib.parse.urlparse(base)");
        sb.AppendLine("if not parsed.hostname:");
        sb.AppendLine("    sys.exit(1)");
        sb.AppendLine("port = parsed.port or (443 if parsed.scheme == 'https' else 80)");
        sb.AppendLine("try:");
        sb.AppendLine("    with socket.create_connection((parsed.hostname, port), timeout=1.0):");
