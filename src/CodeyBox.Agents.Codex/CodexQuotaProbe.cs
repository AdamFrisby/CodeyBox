...
/// <summary>
/// Probes the OpenAI usage endpoint to estimate available Codex subscription
...
{
    internal const string UsageEndpoint = "https://api.openai.com/v1/usage";
    ...
    private async Task<AgentQuotaSnapshot> FetchAsync(CancellationToken ct)
    {
        try
        {
            ...
            {
                _log.LogDebug("Codex quota endpoint returned {StatusCode}; treating quota as unknown",
    ...
    /// <summary>
    /// Parses the OpenAI usage response. Expected shape:
