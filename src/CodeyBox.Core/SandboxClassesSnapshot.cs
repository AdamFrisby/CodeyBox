...
/// bind once into a local for any compound read. Nothing routes through this
/// catalog yet — the provider registry, per-member gates, and call-site
/// rewiring are separate items; this holder is the seam they will consume.
/// </remarks>
