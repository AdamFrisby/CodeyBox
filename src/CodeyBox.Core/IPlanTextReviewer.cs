...
/// without a sandbox or a code diff. The plan-review pipeline composes
/// <see cref="AuditTarget.Plan"/>-target auditors and drives implementers of
/// this seam over the (small, cheap) plan artifact via a host-only text call.
///
