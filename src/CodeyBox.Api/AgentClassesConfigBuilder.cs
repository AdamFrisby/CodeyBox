        ...
        IReadOnlyDictionary<string, CopilotProviderOptions>? copilotProviders = null)
    {
        ...
        foreach (var classOpts in options)
        {
            ...
            foreach (var m in classOpts.Members)
            {
                ...
                if (agentKind == AgentKind.Prime)
                    PrimeKnownModels.ValidateModelIdAgainstProviderList(classOpts.Id, m.ModelId, log);
                if (agentKind == AgentKind.Aider)
                    AiderKnownModels.ValidateModelIdAgainstProviderList(classOpts.Id, m.ModelId, log);
                if (agentKind == AgentKind.Goose)
                    GooseKnownModels.ValidateModelIdAgainstProviderList(classOpts.Id, m.ModelId, log);
                if (agentKind == AgentKind.Autohand)
                    AutohandKnownModels.ValidateModelIdAgainstProviderList(classOpts.Id, m.ModelId, log);
                if (agentKind == AgentKind.Vibe)
                ...
                if (agentKind == AgentKind.Continue)
                    ContinueKnownModels.ValidateModelIdAgainstProviderList(classOpts.Id, m.ModelId, log);
                if (agentKind == AgentKind.Qwen)
                ...
                if (agentKind == AgentKind.Devin)
                    DevinKnownModels.ValidateModelIdAgainstProviderList(classOpts.Id, m.ModelId, log);
                ...
                if (agentKind == AgentKind.Unreal)
                    UnrealKnownModels.ValidateModelIdAgainstProviderList(classOpts.Id, m.ModelId, log);
