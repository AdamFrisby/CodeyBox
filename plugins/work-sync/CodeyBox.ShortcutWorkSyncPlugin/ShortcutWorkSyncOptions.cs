...
public sealed record ShortcutWorkSyncOptions
{
        ...
        IConfigurationSection section, List<string>? warnings = null)
    {
        ...
        return new ShortcutWorkSyncOptions
        {
            ...
            IngestEpics = ReadBool(section, "IngestEpics", defaults.IngestEpics),
            ...
            WebhookSignatureHeader = ReadNonEmpty(section, "WebhookSignatureHeader", defaults.WebhookSignatureHeader),
            ...
            MemberCacheMinutes = Math.Clamp(ReadInt(section, "MemberCacheMinutes", defaults.MemberCacheMinutes), 1, 1440),
        };
    }
