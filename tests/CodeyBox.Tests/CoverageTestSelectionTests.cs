...
public sealed class CoverageTestSelectionTests
{
    ...
    {
        private readonly TestScratchDirectory _scratch = TestScratchDirectory.Create("codeybox-shadow-wiring-");
        private string _dbPath => _scratch.DbPath("shadow-wiring.db");
