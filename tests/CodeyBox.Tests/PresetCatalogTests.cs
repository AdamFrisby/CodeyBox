...
public sealed class PresetCatalogTests
{
    private sealed class FakeAgent : IAgentRunner
    {
        ...
        public Task<AgentResult> RunAsync(ISandbox _, string __, string ___, AgentCredential? ____, string? _____ = null, CancellationToken ______ = default, Action<string>? stdoutChunkCallback = null)
