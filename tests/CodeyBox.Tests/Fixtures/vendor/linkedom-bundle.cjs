...
var require_object = __commonJS({
  "node_modules/linkedom/cjs/shared/object.js"(exports2) {
    ...
    exports2.keys = keys;
    exports2.setPrototypeOf = setPrototypeOf2;
  }
});
...
var require_custom_element_registry = __commonJS({
  "node_modules/linkedom/cjs/interface/custom-element-registry.js"(exports2) {
    ...
    var { entries, setPrototypeOf: setPrototypeOf2 } = require_object();
...
var require_perf_hooks = __commonJS({
  "node_modules/linkedom/commonjs/perf_hooks.cjs"(exports2) {
    try {
      ...
      exports2.performance = performance;
    } catch (fallback) {
...
var require_string_map = __commonJS({
  "node_modules/linkedom/cjs/dom/string-map.js"(exports2) {
    ...
    var { setPrototypeOf: setPrototypeOf2 } = require_object();
...
var require_facades = __commonJS({
  "node_modules/linkedom/cjs/shared/facades.js"(exports2) {
    ...
    var { setPrototypeOf: setPrototypeOf2 } = require_object();
    var illegalConstructor2 = () => {
      throw new TypeError("Illegal constructor");
    };
    exports2.illegalConstructor = illegalConstructor2;
    function Attr() {
      illegalConstructor2();
    }
    exports2.Attr = Attr;
    setPrototypeOf2(Attr, _Attr);
    Attr.prototype = _Attr.prototype;
    function CDATASection() {
      illegalConstructor2();
    }
    exports2.CDATASection = CDATASection;
    setPrototypeOf2(CDATASection, _CDATASection);
    CDATASection.prototype = _CDATASection.prototype;
    function CharacterData() {
      illegalConstructor2();
    }
    exports2.CharacterData = CharacterData;
    setPrototypeOf2(CharacterData, _CharacterData);
    CharacterData.prototype = _CharacterData.prototype;
    function Comment() {
      illegalConstructor2();
    }
    exports2.Comment = Comment;
    setPrototypeOf2(Comment, _Comment);
    Comment.prototype = _Comment.prototype;
    function DocumentFragment() {
      illegalConstructor2();
    }
    exports2.DocumentFragment = DocumentFragment;
    setPrototypeOf2(DocumentFragment, _DocumentFragment);
    DocumentFragment.prototype = _DocumentFragment.prototype;
    function DocumentType() {
      illegalConstructor2();
    }
    exports2.DocumentType = DocumentType;
    setPrototypeOf2(DocumentType, _DocumentType);
    DocumentType.prototype = _DocumentType.prototype;
    function Element() {
      illegalConstructor2();
    }
    exports2.Element = Element;
    setPrototypeOf2(Element, _Element);
    Element.prototype = _Element.prototype;
    function Node() {
      illegalConstructor2();
    }
    exports2.Node = Node;
    setPrototypeOf2(Node, _Node);
    Node.prototype = _Node.prototype;
    function ShadowRoot() {
      illegalConstructor2();
    }
    exports2.ShadowRoot = ShadowRoot;
    setPrototypeOf2(ShadowRoot, _ShadowRoot);
    ShadowRoot.prototype = _ShadowRoot.prototype;
    function Text() {
      illegalConstructor2();
    }
    exports2.Text = Text;
    setPrototypeOf2(Text, _Text);
    Text.prototype = _Text.prototype;
    function SVGElement() {
      illegalConstructor2();
    }
    exports2.SVGElement = SVGElement;
    setPrototypeOf2(SVGElement, _SVGElement);
...
var require_document = __commonJS({
  "node_modules/linkedom/cjs/interface/document.js"(exports2) {
    ...
    var { Facades, illegalConstructor: illegalConstructor2 } = require_facades();
    var { HTMLClasses } = require_html_classes();
    var { Mime } = require_mime();
    var { knownSiblings } = require_utils();
    var { assign, create, defineProperties, setPrototypeOf: setPrototypeOf2 } = require_object();
    var { NonElementParentNode } = require_non_element_parent_node();
    var { SVGElement } = require_element2();
    var { Attr } = require_attr();
...
var require_document2 = __commonJS({
  "node_modules/linkedom/cjs/html/document.js"(exports2) {
    ...
    var { Document: Document2 } = require_document();
    var { NodeList } = require_node_list();
