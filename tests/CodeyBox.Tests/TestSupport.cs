...
internal sealed partial class ScriptedAgent : IAgentRunner
{
    ...
    public async Task<AgentResult> RunAsync(ISandbox sandbox, string workingDirectory, string prompt, AgentCredential? credential, string? modelId = null, CancellationToken ct = default, Action<string>? stdoutChunkCallback = null)
    {
