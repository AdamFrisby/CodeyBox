...
{
    private readonly TestScratchDirectory _scratch = TestScratchDirectory.Create("codeybox-throwing-cost-httptest-");
    private string _dbPath => _scratch.DbPath("throwing-cost-httptest.db");
