...
{
    private readonly TestScratchDirectory _scratch = TestScratchDirectory.Create("codeybox-uat-changelog-");
    private string _dbPath => _scratch.DbPath("uat-changelog.db");
