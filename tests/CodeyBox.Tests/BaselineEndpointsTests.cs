...
{
    private readonly TestScratchDirectory _scratch = TestScratchDirectory.Create("codeybox-baseline-api-");
    private string _dbPath => _scratch.DbPath("baseline-api.db");
