...
public sealed class TestRunnerAuditorProgramWiringTests
{
    ...
    {
        private readonly TestScratchDirectory _scratch = TestScratchDirectory.Create("codeybox-testrunner-wiring-");
        private string _dbPath => _scratch.DbPath("testrunner-wiring.db");
