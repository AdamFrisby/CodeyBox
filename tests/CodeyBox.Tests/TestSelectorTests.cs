...
public sealed class TestSelectorTests
{
    ...
    {
        private readonly TestScratchDirectory _scratch = TestScratchDirectory.Create("codeybox-selector-wiring-");
        private string _dbPath => _scratch.DbPath("selector-wiring.db");
