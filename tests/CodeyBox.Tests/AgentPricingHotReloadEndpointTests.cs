...
{
    private readonly TestScratchDirectory _scratch = TestScratchDirectory.Create("codeybox-pricing-hotreload-");
    private string _dbPath => _scratch.DbPath("pricing-hotreload.db");
