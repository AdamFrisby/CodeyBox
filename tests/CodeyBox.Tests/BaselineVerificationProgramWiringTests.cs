...
public sealed class BaselineVerificationProgramWiringTests
{
    ...
    private sealed class BaselineVerificationFactory : WebApplicationFactory<Program>
    {
        ...
        private readonly TestScratchDirectory _scratch = TestScratchDirectory.Create("codeybox-baseline-verify-wiring-");
        private string _dbPath => _scratch.DbPath("baseline-verify-wiring.db");
