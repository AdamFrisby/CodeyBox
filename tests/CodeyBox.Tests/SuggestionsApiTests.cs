...
internal sealed class SuggestionsApiFactory : WebApplicationFactory<Program>
{
    ...
    private readonly TestScratchDirectory _scratch = TestScratchDirectory.Create("codeybox-suggestionshttp-");
    private string _dbPath => _scratch.DbPath("suggestionshttp.db");
