...
{
    private readonly TestScratchDirectory _scratch = TestScratchDirectory.Create("codeybox-budget-httptest-");
    private string _dbPath => _scratch.DbPath("budget-httptest.db");
