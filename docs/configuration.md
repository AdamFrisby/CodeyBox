...
| `SandboxNetworkProfiles.graphical` | string | `cb-graphical` | Fallback bridge for graphical projects when a graphical-eligible phase has no configured per-phase profile; create it with `scripts/setup-host-networks.sh`. |
