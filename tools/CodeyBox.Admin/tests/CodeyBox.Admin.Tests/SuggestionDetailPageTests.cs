...
internal sealed class DetailFakeClient : ICodeyBoxApiClient
{
    ...
    public Task<string?> GetAuditReportRawOutputAsync(string workItemId, string target, int iteration, string auditorName, CancellationToken ct = default) => Task.FromResult<string?>(null);
    ...
    public Task<AgentStreamAggregateDto?> GetWorkItemAgentStreamAggregateAsync(string id, CancellationToken ct = default) => Task.FromResult<AgentStreamAggregateDto?>(null);
    ...
    public Task<List<QuestionDto>> GetQuestionsAsync(string workItemId, CancellationToken ct = default) => Task.FromResult(new List<QuestionDto>());
    public Task<bool> AnswerQuestionAsync(string workItemId, string questionId, string answer, CancellationToken ct = default) => Task.FromResult(true);
    public Task<bool> DismissQuestionAsync(string workItemId, string questionId, string reason, CancellationToken ct = default) => Task.FromResult(true);
